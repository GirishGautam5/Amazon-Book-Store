      ...
      <table className="table" striped bordered hover variant="dark">
        ...
        <tbody>
          {products.map(product => (<tr key={product._id}>
            ...
            <td>
              <button className="button" onClick={() => openModal(product)} ><i className="fa fa-edit" aria-hidden="true"></i></button>
              {' '}
              <button className="button" onClick={() => deleteHandler(product)} ><i className="fa fa-trash" aria-hidden="true"></i></button>
            </td>
          </tr>))}
        </tbody>
      </table>
